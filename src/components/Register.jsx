      ...
      <div className="border-2 rounded-lg px-16 py-10 border-[#2121DE] md:w-5/12 flex flex-col justify-between">
        ...
        <div className="md:px-6 py-4 md:mt-4 grid place-items-center">
          ...
          >
            ...
            />
            <button
              className={`shadow-lg hover:shadow-yellow-500 transition-all duration-300 font-mono flex items-center gap-2 border-2 border-[#FFFF00] rounded-md justify-center py-3 ${
